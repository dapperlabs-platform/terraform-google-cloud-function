...
variable "source_repository" {
  description = "Google Cloud Source Repository URL"
  type        = string
  default     = null
}
...
variable "schedule" {
  description = "Cron schedule for pubsub trigger"
  type        = string
  default     = null
}

variable "pubsub_trigger_retry" {
  description = "Retry config for schedule trigger"
  type        = bool
  default     = false
}
